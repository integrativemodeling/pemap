...
# Read files
###########################
modeling_script = '../modeling/mod_pemap_bacrnap.py'
mmcif_file = '../modeling/BacRNAP_pEMAP_initial.cif'
...
################################################
input_information = {}
input_information['Prior models'] = ['X-ray structure 4YG2']
input_information['Physical principles and statistical preferences'] = ['Excluded volume', 'Sequence connectivity']
input_information['Experimental data'] = ['63 conditional genetics derived distance restraints']
