...
export cl=0
export top_dir=/home/ignacia/Research/pE-MAP/mod_hist_40_2/
...
nohup ~/SOFTW/imp_november/setup_environment.sh python ~/SOFTW/imp-sampcon/pyext/src/Master_Sampling_Exhaustiveness_Analysis.py --sysname $name --path $mod_dir --mode cuda --align --density density.txt --gridsize 4.0 --gnuplot --scoreA Scores_A.txt --scoreB Scores_B.txt  --rmfs_A $analys_dir/selected_models_A_cluster${cl}_random.dat --rmfs_B $analys_dir/selected_models_B_cluster${cl}_random.dat --subsample 20000 > clustering.log &
