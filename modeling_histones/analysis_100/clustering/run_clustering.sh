...
export top_dir=/home/ignacia/Research/pE-MAP/mod_hist_100/
...
nohup python ~/SOFTW/imp-sampcon-new/pyext/src/Master_Sampling_Exhaustiveness_Analysis.py --sysname $name --path $mod_dir --mode cuda --cores 4 --align --density density.txt --gridsize 2.0 --gnuplot --scoreA Scores_A.txt --scoreB Scores_B.txt  --rmfs_A $analys_dir/selected_models_A_cluster1_random.dat --rmfs_B $analys_dir/selected_models_B_cluster1_random.dat --subsample 20000 > clustering.log &
