...
export top_dir=/home/ignacia/Research/pE-MAP/mod_hist_40/
export analys_dir=$top_dir/analys
export mod_dir=$analys_dir/GSMs_cl1/
export name=HIS_hist_40
...
nohup ~/SOFTW/imp_november/setup_environment.sh python ~/SOFTW/imp-sampcon/pyext/src/Master_Sampling_Exhaustiveness_Analysis.py --sysname $name --path $mod_dir --mode cuda --align --density density.txt --gridsize 5.2 --gnuplot --scoreA Scores_A.txt --scoreB Scores_B.txt  --rmfs_A $analys_dir/selected_models_A_cluster1_random.dat --rmfs_B $analys_dir/selected_models_B_cluster1_random.dat --subsample 20000 > clustering.log &
